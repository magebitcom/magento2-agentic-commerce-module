...
class Products extends ApiController implements HttpGetActionInterface
{
    /**
     ...
     * @return int|null
     */
    private function intParam(Http $request, string $name): ?int
    {
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            $payload = $this->feedService->products($feedId, $this->intParam($request, 'limit'), (int) $this->intParam($request, 'offset'));
            ...
            $this->logger->critical('[AgenticCommerce] Error retrieving products for feed', ['exception' => $e]);
